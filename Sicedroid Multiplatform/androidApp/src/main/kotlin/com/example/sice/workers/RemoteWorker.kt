    ...
    override suspend fun doWork(): WorkResult {
        ...
        return try {
            val result = when (tipo) {
                "perfil"-> mainRepository.remote.profile()
                "carga"-> mainRepository.remote.cargaAcademica()
                "cardex"-> mainRepository.remote.cardex(1)
                "califUnidades"-> mainRepository.remote.calificacionesPorUnidad()
                "califFinal"-> mainRepository.remote.calificacionFinal(1)
                else -> null
            }
