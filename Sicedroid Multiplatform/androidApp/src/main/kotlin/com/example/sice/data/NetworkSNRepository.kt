...
import com.example.sice.Network.bodyCalificacionFinal
import com.example.sice.Network.bodyCalificacionesUnidades
import com.example.sice.Network.bodyCardex
import com.example.sice.Network.bodyCargaAcademica
import com.example.sice.Network.bodyPerfil
import com.example.sice.Network.bodyacceso
...
class NetworSNRepository(
    ...
    // tambien se elimina
    // backing field privado para la matrícula
    private var _currentMatricula: String? = null
    ...
    override fun hasSession(): Boolean {
        ...
        return !cookies.isNullOrEmpty() && _currentMatricula != null
    }
    ...
    override suspend fun profile(): ProfileStudent? {
        ...
        val bodyPerfilFormatted = bodyPerfil.format(_currentMatricula ?: "")
        ...
        return try {
            ...
            ProfileStudent(
                matricula = jsonObj.optString("matricula", _currentMatricula ?: ""),
